# Limpiezas de Incendios Alpha

Web estática independiente para **limpieza después de incendio**.

| Campo | Valor |
|---|---|
| Dominio previsto | https://limpiezadeincendiosalpha.es/ |
| Teléfono | 681811301 |
| Email | info@miweb.es |
| Dirección | Madrid, Calle Ave del Paraiso, 123 08001 |
| Repositorio previsto | `web-limpiezas-alpha` |
